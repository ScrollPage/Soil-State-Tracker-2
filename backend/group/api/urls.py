...
cluster = ClusterViewSet.as_view({"get": "list", "post": "create"})
...
detector_remove = ClusterViewSet.as_view({"post": "remove_detector"})

cluster_mean_data = ClusterViewSet.as_view({"get": "get_mean_data"})
